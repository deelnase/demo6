...
@Override
    ...
    Media media = new Media(new File("C:\\Users\\User\\Documents\\Apowersoft\\Apowersoft Online Screen Recorder\\da.mp4").toURI().toString());
...
labelTime.setText("00:00:00/" + totalTime);
    ...
    primaryStage.setTitle("Chapter16_24");
